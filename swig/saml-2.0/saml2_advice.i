...
#define LassoSaml2Advice_set_AssertionIDRef(self,value) set_node_list((gpointer*)&(self)->AssertionIDRef, (value))
#define LassoSaml2Advice_AssertionIDRef_set(self,value) set_node_list((gpointer*)&(self)->AssertionIDRef, (value))
...
#define LassoSaml2Advice_set_AssertionURIRef(self,value) set_string_list((gpointer*)&(self)->AssertionURIRef, (value))
#define LassoSaml2Advice_AssertionURIRef_set(self,value) set_string_list((gpointer*)&(self)->AssertionURIRef, (value))
...
#define LassoSaml2Advice_set_Assertion(self,value) set_node_list((gpointer*)&(self)->Assertion, (value))
#define LassoSaml2Advice_Assertion_set(self,value) set_node_list((gpointer*)&(self)->Assertion, (value))
...
#define LassoSaml2Advice_set_EncryptedAssertion(self,value) set_node_list((gpointer*)&(self)->EncryptedAssertion, (value))
#define LassoSaml2Advice_EncryptedAssertion_set(self,value) set_node_list((gpointer*)&(self)->EncryptedAssertion, (value))
